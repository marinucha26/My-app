...
function Header() {
    ...
    const [showLightnings, setShowLightnings] = useState(true);
    ...
    useEffect(() => { const timer = setTimeout(() => {
        ...
        return () => clearTimeout(timer);
         ...
         const quotes = [
        "Кофе, плед и никаких дел!",
        "Новая книга - новая жизнь!",
        "Штормит? Открывай книгу!"
        ];
    ...
    return (
        <header className="header">
            {showLightnings && (
                <div className="lightnings-storm">
            ...
            <div className="header-button-block">
                <button type="button" onClick={toggleMenu} className="header-button">
            ...
            <div className="header-block">
                <h1 className="header-title">🪄 
                    ...
                    <div className="magic-decoration">
